...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dragonwarrior: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dragonwarrior ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/AppDragonWarrior.o: src/AppDragonWarrior.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AppDragonWarrior.o src/AppDragonWarrior.cpp

${OBJECTDIR}/src/CtxOverworld.o: src/CtxOverworld.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CtxOverworld.o src/CtxOverworld.cpp
